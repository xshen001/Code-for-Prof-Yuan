...
4. `tabarena_prediction_level_for_professor_yuan_20260707_gated.zip`
...
5. `tabarena_prediction_level_for_professor_yuan_20260706.zip`
   ...
   Earlier TabArena prediction-level package kept for record only.
...
- TabArena prediction-level rerun: `tabarena_prediction_level_type_aware_gated_*_return_to_authors.zip`
